...
<div class="i_bg bg_color">
        ...
        <div class="inews">
            ...
            <ul>
            	...
            	<c:forEach items="${newList}" var="n">
            		<li><span>[ 特惠 ]</span><a href="#">${n.title}</a></li>
            	</c:forEach>
            </ul>
            <div class="charge_t">
    ...
    <!--End 进口 生鲜 End-->
   	...
   	<c:forEach items="${PRO_CATE}" var="proCate" varStatus="pc">
   		<div class="i_t mar_10">
    	<span class="floor_num">${pc.index+1}F</span>
   	...
   	<div class="content">
        ...
        <div class="fresh_mid">
        	<ul>
               <c:forEach items="${proList}" var="pro" varStatus="p">
               		<c:if test="${fn:trim(proCate.id)== fn:trim(pro.categoryLevel1Id)}">
               			<c:if test="${p.index%6!=0}">
               				<li>
			                	<div class="name"><a href="${ctx}/productServlet?action=show&id=${pro.id}">${pro.name}</a></div>
			                    <div class="price">
			                    	<font>￥<span>${pro.price}</span></font> &nbsp; 26R
			                    </div>
			                    <div class="img"><a href="${ctx}/productServlet?action=show&id=${pro.id}"><img src="${ctx}/statics/images/${pro.fileName}" width="185" height="155" /></a></div>
			                </li>
